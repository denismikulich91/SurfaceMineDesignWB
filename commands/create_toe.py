...
class CreateToe:
    ...
    def Activated(self):
        ...
        if not mesh_objects:
            QtWidgets.QMessageBox.warning(None, "No Optimization shells", "There are no shells in the document to select.")
            return

        dialog = CreateToeDialog(mesh_objects, object_list)
